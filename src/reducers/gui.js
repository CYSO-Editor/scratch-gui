...
import workspaceWindowsReducer, {workspaceWindowsInitialState} from './workspace-windows';
...
const guiInitialState = {
    ...
    workspaceWindows: workspaceWindowsInitialState
};
...
const guiReducer = combineReducers({
    ...
    workspaceWindows: workspaceWindowsReducer
});
